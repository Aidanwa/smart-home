...
Guidelines:
- If user asks about a specific time (e.g., “6pm today”), call get_weather with an ISO time if possible. Be concise.
"""

class WeatherAgent(Agent):

    def __init__(self, model: Optional[str] = None, *, include_time: bool = True):
        super().__init__(
            model=model,
